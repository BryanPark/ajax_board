...
$conn = mysqli_connect('localhost', 'gboard_codys','@@codys0215','gboard_codys_db');
$table_name_board = "practice2";
$table_name_member = "practice";
...
//exit;
	...
	$result=mysqli_query($conn, "SELECT {$table_name_board}.seq, {$table_name_board}.name,{$table_name_board}.title, {$table_name_board}.content FROM {$table_name_board} where seq=$seq" );
	$row=mysqli_fetch_array($result);
